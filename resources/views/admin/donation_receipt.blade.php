@php
    $layout = request()->ajax() ? 'layouts.blank' : 'layouts.admin_receipt';
@endphp
...
<head>
    ...
    <title>Donation Receipt - Admin View</title>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        body { background: transparent; color: #111827; padding: 20px; display: flex; align-items: center; justify-content: center; }
        ...
        .btn-rcpt-dl { width: 100%; padding: 14px; border: 1px solid #d1d5db; background: #fff; color: #111827; border-radius: 8px; font-size: 13px; font-weight: 700; cursor: pointer; text-align: center; }
    ...
    <div class="receipt-card">
        ...
        <div class="receipt-thankyou">
            ...
            <div class="rt-desc">System Record: 
                <span style="color: #00827F; font-weight: 600;">{{ strtoupper($donation->status) }}</span>
            </div>
        </div>
        ...
        <div class="receipt-footer">
            <div class="rf-stamp">OFFICIAL<br>ADMIN<br>COPY</div>
            <div class="rf-bottom">
